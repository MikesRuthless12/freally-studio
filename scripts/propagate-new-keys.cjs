...
const newKeyTranslations = {
  ...
  "ui.installDesktopApp": {
    es: "Instalar WavLoom como app de escritorio", fr: "Installer WavLoom en tant qu'application de bureau",
    de: "WavLoom als Desktop-App installieren", it: "Installa WavLoom come app desktop",
    pt: "Instalar WavLoom como app desktop", ja: "WavLoomをデスクトップアプリとしてインストール",
    ko: "WavLoom을 데스크톱 앱으로 설치", zh: "安装WavLoom为桌面应用", ru: "Установить WavLoom как настольное приложение",
    ar: "تثبيت WavLoom كتطبيق سطح مكتب", hi: "WavLoom को डेस्कटॉप ऐप के रूप में इंस्टॉल करें",
    nl: "WavLoom installeren als desktop-app", pl: "Zainstaluj WavLoom jako aplikację desktopową",
    tr: "WavLoom'u masaüstü uygulaması olarak kur", sv: "Installera WavLoom som skrivbordsapp",
    nb: "Installer WavLoom som skrivebordsapp", da: "Installer WavLoom som desktop-app",
    fi: "Asenna WavLoom työpöytäsovelluksena", cs: "Nainstalovat WavLoom jako desktopovou aplikaci",
    ro: "Instalează WavLoom ca aplicație desktop", hu: "WavLoom telepítése asztali alkalmazásként",
    th: "ติดตั้ง WavLoom เป็นแอปเดสก์ท็อป", vi: "Cài đặt WavLoom làm ứng dụng máy tính",
    id: "Instal WavLoom sebagai aplikasi desktop", uk: "Встановити WavLoom як настільний додаток",
    el: "Εγκατάσταση WavLoom ως εφαρμογή επιφάνειας εργασίας", he: "התקן את WavLoom כאפליקציית שולחן עבודה",
    sk: "Nainštalovať WavLoom ako desktopovú aplikáciu", ms: "Pasang WavLoom sebagai aplikasi desktop",
    hr: "Instaliraj WavLoom kao desktop aplikaciju", ca: "Instal·la WavLoom com a aplicació d'escriptori",
    bg: "Инсталирай WavLoom като настолно приложение", sr: "Инсталирај WavLoom као десктоп апликацију",
    lt: "Įdiegti WavLoom kaip darbalaukio programą", lv: "Instalēt WavLoom kā darbvirsmas lietotni",
    sl: "Namesti WavLoom kot namizno aplikacijo", et: "Paigalda WavLoom töölauarakendusena",
    gl: "Instalar WavLoom como aplicación de escritorio", af: "Installeer WavLoom as 'n lessenaar-toep",
    az: "WavLoom-u masaüstü tətbiqi olaraq quraşdır", bs: "Instaliraj WavLoom kao desktop aplikaciju",
    mk: "Инсталирај WavLoom како десктоп апликација", tl: "I-install ang WavLoom bilang desktop app",
    be: "Усталяваць WavLoom як настольнае прыкладанне"
  },
  "ui.emoji": {
