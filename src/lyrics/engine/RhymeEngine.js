...
const RHYME_FAMILIES = {
    ...
    // === O-sounds ===
    'ow': ['know', 'go', 'show', 'flow', 'grow', 'glow', 'below', 'follow', 'shadow', 'window', 'tomorrow', 'sorrow', 'hollow', 'overflow', 'rainbow', 'echo', 'hero', 'zero', 'blow', 'slow', 'snow', 'throw', 'row', 'low', 'toe', 'foe', 'woe', 'so', 'no', 'pro', 'ago', 'also', 'cargo', 'solo', 'motto', 'photo', 'disco', 'tempo', 'volcano', 'tornado', 'buffalo', 'domino', 'dynamo', 'embryo', 'flamingo', 'indigo', 'inferno', 'manifesto', 'portfolio', 'scenario', 'studio', 'torpedo', 'vertigo', 'undertow', 'overthrow', 'outgrow', 'bestow', 'elbow', 'sparrow', 'meadow', 'pillow', 'willow', 'borrow', 'narrow', 'arrow', 'shallow', 'mellow', 'yellow', 'fellow', 'cello'],
